...
<section class="container">
	...
	<div id="pageflip">
		<div class='cover' data-background-file='<?php echo $pasta ?>pageflipdata/page0.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page0_th.jpg/?v=123' data-page-label='t0'></div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page1.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page1_th.jpg/?v=123' data-page-label='t1'>
		...
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page2.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page2_th.jpg/?v=123' data-page-label='t2'>
		...
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page3.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page3_th.jpg/?v=123' data-page-label='t3'>
		...
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page4.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page4_th.jpg/?v=123' data-page-label='t4'>
		...
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page5.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page5_th.jpg/?v=123' data-page-label='t5'>
		...
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page6.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page6_th.jpg/?v=123' data-page-label='t6'>
		...
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page7.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page7_th.jpg/?v=123' data-page-label='t7'>
		...
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page8.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page8_th.jpg/?v=123' data-page-label='t8'>
		...
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page9.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page9_th.jpg/?v=123' data-page-label='t9'>
		...
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page10.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page10_th.jpg/?v=123' data-page-label='t10'>
		...
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page11.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page11_th.jpg/?v=123' data-page-label='t11'>
		...
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page12.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page12_th.jpg/?v=123' data-page-label='t12'>
		...
		<div class='cover' data-background-file='<?php echo $pasta ?>pageflipdata/page13.jpg/?v=123' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page13_th.jpg/?v=123' data-page-label='t13'>
			<div class='pf-hotspot' style='top:1273px;left:396px;width:359px;height:29px;' onclick='u("https://montecristo.com.br/")'></div>
			<div class='pf-hotspot' style='top:1400px;left:366px;width:460px;height:29px;' onclick='u("https://api.whatsapp.com/send/?phone=5511964175881&text&app_absent=0")'></div>
			<div class='pf-hotspot' style='top:1824px;left:76px;width:460px;height:112px;' onclick='u("https://montecristo.com.br/lojas#Shopping-Iguatemi-SP")'></div>
			<div class='pf-hotspot' style='top:1824px;left:537px;width:606px;height:112px;' onclick='u("https://montecristo.com.br/lojas#Shopping-JK-Iguatemi")'></div>
			...
			<div class='pf-hotspot' style='top:1146px;left:53px;width:348px;height:42px;' onclick='u("https://www.instagram.com/montecristo.joalheria/")'></div>
			<div class='pf-hotspot' style='top:1146px;left:429px;width:326px;height:42px;' onclick='u("https://www.facebook.com/montecristojoalheria/")'></div>
			<div class='pf-hotspot' style='top:1146px;left:768px;width:336px;height:36px;' onclick='u("https://www.linkedin.com/company/montecristojoalheria/")'></div>
		</div>
...
<g>
	...
	<script type="text/javascript">
		...
		$pageflip.pageflipInit({
			...
			ShareImageURL: 'pageflipdata/page0.jpg/?v=123',
			DisableSelection: true,
			CenterSinglePage: false,
			SinglePageMode: true,
			ShowCopyright: false,
			Copyright: '©2016 pageflip-books.com',
			Key: 'dTVMHtEixX$LF/Sg5b'
		}, "diamondvalentine");
