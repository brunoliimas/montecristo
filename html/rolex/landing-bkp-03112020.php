...
?>
    ...
    <div id="rlx-wrapper">
        ...
        <section class="rlx-top-banner"
                 style="background:url('<?php echo base_url("img/rolex/Landing_top_banner_img_1680x420.jpg") ?>');
            ...
            <div class="internal">
                ...
                <div class="featured-modules">
                    <div class="module">
                        ...
                        <div class="module-image" style="background-image:url(<?php echo base_url('img/rolex/mens-watches_sky_dweller.jpg') ?>); background-repeat: no-repeat; background-size:cover; background-position: center center;"></div>
                        <span>Relógios Rolex Masculinos</span>
                    </div>
                    <div class="module">
                        <a class="clickbox" href="<?php echo site_url('rolex/colecao/?cmplp=watches/woman') ?>"><span></span></a>
                        <div class="module-image" style="background-image:url(<?php echo base_url('img/rolex/womens-watches_pearlmaster_39.jpg') ?>); background-repeat: no-repeat; background-size:cover; background-position: center center;"></div>
                    ...
                    <div class="module module-wide">
                        ...
                        <div class="module-image" style="background-image:url(<?php echo base_url('img/rolex/gold-watches.jpg') ?>); background-repeat: no-repeat; background-size:cover; background-position: center center;"></div>
