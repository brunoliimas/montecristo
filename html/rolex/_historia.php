...
<div class="bf-rolex">
    <section class="breadcrumbcontent">
        <div class="breadcrumb"><a href="/rolex">Rolex</a><span> &gt; </span><a href="#">Nossa História</a></div>
    </section>
    <div class="banner-rolex-desktop">
        <div class="box-banner">
            <a>
                <picture>
                    <source
                        srcset="<?php echo image_compatibility(site_url("img/rolex/img/OUR_HISTORY.webp"), 'webp') ?>">
            ...
            <div class="img-left">
                <div class="img-left-image">
                    <picture>
                        ...
                        <img alt="Entrada loja Montecristo" title="Entrada loja Montecristo"
                            src="<?php echo base_url('img/rolex/img/OUR_SHOWROOM_3.jpg') ?>">
                    </picture>
                </div>
            ...
            <div class="img-right">
                ...
                <div class="img-right-image">
                    <picture>
                        ...
                        <img alt="Interior Showroom Rolex Montecristo" title="Interior Showroom Rolex Montecristo"
                            src="<?php echo base_url('img/rolex/img/OUR_SHOWROOM_4.jpg') ?>">
                    </picture>
                </div>
            </div>
            ...
            <div class="img-left">
                <div class="img-left-image">
                    <picture>
                        ...
                        <img alt="Interior Showroom Rolex Montecristo" title="Interior Showroom Rolex Montecristo"
                            src="<?php echo base_url('img/rolex/img/OUR_SHOWROOM_5.jpg') ?>">
                    </picture>
                </div>
                <div class="img-left-text">
                    <div class="internal">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 padding_0">
                    <picture>
                        <source srcset="<?php echo base_url('img/rolex/img/banner-footer-retrato.webp') ?>"
                            media="(max-width: 991px)">
                        <img src="<?php echo base_url('img/rolex/img/banner-footer.jpg') ?>" class="img-responsive"
                            alt="">
                    </picture>
                </div>
            </div>
