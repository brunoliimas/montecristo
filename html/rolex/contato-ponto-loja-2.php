            ...
            <div class="infosdistribuidor">
                ...
                <div class="informacao">
                    <div class="informacao-content">
                        ...
                        <address class="informacao-address">
                            <span class="informacao-address-more">
                        ...
                        <div class="informacao-funcionamento">
                            <button id="informacao-funcionamento" class="informacao-funcionamento-btn">
                                <span class="informacao-funcionamento-btn-horario">10h00 às 21h30</span>
                            ...
                            <ul id="opening-hours-list" class="informacao-funcionamento-lista-horario" hidden>
                                ...
                                <li class="informacao-funcionamento-lista-horario-item"><span>Dom</span><span>Fechado</span>
                                </li>
                            </ul>
                        </div>
                        <div class="informacao-moreinfos">
                            <div title="ligar para o distribuidor" class="informacao-moreinfos-telefone">
                                <a onclick="_satellite.track('contactCall')" href="tel:5519996568880" class="informacao-moreinfos-telefone-icon" rel="noopener" data-outlink="tel: 55 11 3152 6660" title="" target="_parent">
                                ...
                                <span class="informacao-moreinfos-telefone-texto">+ 55 19 9 9656-8880</span>
                            </div>
                            <div title="entre em contato pelo whatsapp" class="informacao-moreinfos-telefone">
                                <a onclick="_satellite.track('whatsappContact')" href="https://wa.me/5511964175881 " class="informacao-moreinfos-telefone-icon" rel="noopener" data-outlink="tel: 55 11 3152 6660" title="" target="_parent">
                                    <span class="sc-jtzltm gjgikf">
                                        <span class="sc-iayfgw ybunm">
                                ...
                                <span class="informacao-moreinfos-telefone-texto">+ 55 11 9 6417-5881 </span>
                            </div>
                            ...
                            <div title="itinerário" class="informacao-moreinfos-itinerario">
                                <a onclick="_satellite.track('getDirections')" target="_blank" href="https://goo.gl/maps/LXGXTEMHjnckAAEVA" class="informacao-moreinfos-itinerario-icon" data-outlink="https://goo.gl/maps/rU2x66X6YnaQfvbr6" title="" target="_blank">
                                    <span class="sc-jtzltm gjgikf">
                                        <span class="sc-iayfgw ybunm">
                                            <svg height="15" width="15" viewbox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" alt="">
