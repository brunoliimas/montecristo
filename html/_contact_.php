	...
	$(document).ready(function() {
		...
		$('.contactForm').ajaxForm({
			success: function(out) {
				if (out.status) {
					$.fancybox("<div class='thank-msg' style='padding:20px'>" + out.msg + "</div>");
				} else {
					$.fancybox("<div class='thank-msg' style='padding:20px'><b>Atenção, corrija os erros listados:</b><br>" + out.msg + "</div>");
				}
			},
			error: function(out, error, msg) {
				$.fancybox("<div class='thank-msg' style='padding:20px'><b>Atenção, corrija os erros listados:</b><br>" + msg + "</div>");
			},
