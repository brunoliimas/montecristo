...
<section class="container detalhe-produto" style="position:relative">
                ...
                <div class="col-md-8 col-sm-8 col-xs-8">
                    <a href="<?php echo base_url('admin/upload/item/' . $item->imagem); ?>" style="cursor:crosshair;" class="imgdetzoom" rel="imgdetzoom">
                        <picture>
                            ...
                            <img class="cloudzoom img-zoom-1 img-responsive" id="zoom1" src="<?php echo base_url('admin/upload/item/' . $item->imagem); ?>" data-cloudzoom="zoomImage:'<?php echo base_url('admin/upload/item/' . @$item->imagem); ?>', zoomSizeMode:'image', tintColor:'#fff', captionPosition:'bottom', maxMagnification:4, autoInside:true, zoomPosition:'inside', zoomOffsetX:0" title="<?= $item->nome ?>" alt="<?= htmlentities(nl2br($item->descricao)) ?>" width="617" height="443" loading="lazy">
                        </picture>
                    </a>
                </div>
                <div class="col-md-4">
        ...
        ?>
            <div class="row">
                ...
                <div class="col-md-5 col-sm-8 col-xs-8" style="z-index: 1">
                    <a href="<?php echo base_url('admin/upload/item/' . $item->imagem) ?>" style="cursor:crosshair;" class="imgdetzoom" rel="imgdetzoom">
                        <img class="cloudzoom img-zoom-1 img-responsive" id="zoom1" src="<?php echo base_url('admin/upload/item/' . $item->imagem); ?>" data-cloudzoom="zoomImage: '<?php echo base_url('admin/upload/item/' . @$item->imagem); ?>', zoomSizeMode:'image',tintColor:'#fff', captionPosition:'bottom', maxMagnification:4, autoInside:true, zoomPosition:'inside', zoomOffsetX:0" title="<?= $item->nome ?>" alt="<?= nl2br($item->descricao) ?>" width="617" height="443" loading="lazy">
                    </a>
                </div>
                <div class="col-md-4">
                    <?php require_once 'includes/dados-detalhe-produto.php'; ?>
    ...
    <div class="row">
        ...
        <div class="col-md-4 row hide">
            ...
            <a href="<?php echo base_url('admin/upload/item/' . $item->imagem) ?>" style="cursor:crosshair;" class="imgdetzoom" rel="imgdetzoom" />
            <img class="cloudzoom img-zoom-1 img-responsive" id="zoom1" src="<?php echo timthumb_url('admin/upload/item/' . $item->imagem, '612', '469') ?>" data-cloudzoom="zoomImage: '<?php echo base_url('admin/upload/item/' . @$item->imagem) ?>', zoomSizeMode: 'image', tintColor:'#fff', tintOpacity:0, captionPosition: 'bottom', maxMagnification:4, autoInside:100, zoomPosition:'12', zoomOffsetX: -20" title="<?= $item->nome ?>" alt="<?= nl2br($item->descricao) ?>" width="617" height="443" loading="lazy">
            </a>
        ...
        <div class="col-md-4 descricao-detalhe hidden-md hidden-lg">
            ...
            <?php if (!($item->qtd_estoque > 0 && $item->preco > 0)) : ?>
                <!-- aqui  -->
                <!-- <h3 class="register-link">
                    <a href="#register-page" class="fancybox" rel="group">
                        REGISTRE SEU INTERESSE
                    </a>
                </h3> -->
                <a href="https://wa.me/5511964175881?text=Oi,%20tenho%20interesse%20no%20produto%20<?php echo site_url("produto/" . $item->slug); ?>" onclick="return gtag_report_conversion('https://wa.me/5511964175881?text=Oi,%20tenho%20interesse%20no%20produto%20<?php echo site_url("produto/" . $item->slug); ?>');" aria-label="Whatsapp" rel="noopener nofollow">
                    <div class="register-link" style="display: flex; padding: 4px 12px; justify-content: space-between; align-items: center;">
                        <span class="">FALE COM O CONCIERGE</span>
                        <i class="fa fa-whatsapp" aria-hidden="true"></i>
                    </div>
                </a>
            <?php endif; ?>
