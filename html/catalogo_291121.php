...
<section class="container">
	...
	<div id="pageflip">
		...
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page1.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page1_th.webp' data-page-label='t1'></div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page2.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page2_th.webp' data-page-label='t2'>
			<div class='pf-hotspot' style='top:555px;left:75px;width:114px;height:146px;' onclick='u("https://montecristo.com.br/produto/OP000146-Santos-de-Cartier-Ballpoint-Pen")'></div>
			<div class='pf-hotspot' style='top:448px;left:83px;width:98px;height:73px;' onclick='u("https://montecristo.com.br/produto/OG000144-Abotoaduras-Cartier-Decoracao-Selo-de-Cera")'></div>
			<div class='pf-hotspot' style='top:99px;left:86px;width:242px;height:133px;' onclick='u("https://montecristo.com.br/relogios/Cartier")'></div>
			<div class='pf-hotspot' style='top:277px;left:90px;width:238px;height:130px;' onclick='u("https://montecristo.com.br/relogios/Cartier")'></div>
			<div class='pf-hotspot' style='top:446px;left:80px;width:255px;height:63px;' onclick='u("https://montecristo.com.br/produto/OG000144-Abotoaduras-Cartier-Decoracao-Selo-de-Cera")'></div>
			<div class='pf-hotspot' style='top:563px;left:71px;width:265px;height:125px;' onclick='u("https://montecristo.com.br/produto/OP000146-Santos-de-Cartier-Ballpoint-Pen")'></div>
		</div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page3.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page3_th.webp' data-page-label='t3'></div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page4.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page4_th.webp' data-page-label='t4'>
			<div class='pf-hotspot' style='top:85px;left:86px;width:242px;height:136px;' onclick='u("https://montecristo.com.br/relogios/Cartier")'></div>
			<div class='pf-hotspot' style='top:247px;left:83px;width:245px;height:136px;' onclick='u("https://montecristo.com.br/relogios/Cartier")'></div>
			<div class='pf-hotspot' style='top:409px;left:80px;width:255px;height:99px;' onclick='u("https://montecristo.com.br/produto/AN2004-Anel-Rho")'></div>
			<div class='pf-hotspot' style='top:534px;left:80px;width:255px;height:95px;' onclick='u("https://montecristo.com.br/produto/AN2025-Anel-Rho")'></div>
			<div class='pf-hotspot' style='top:654px;left:66px;width:283px;height:54px;' onclick='u("https://montecristo.com.br/produto/PU30746-Pulseira-Black-Interlaced")'></div>
		</div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page5.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page5_th.webp' data-page-label='t5'></div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page6.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page6_th.webp' data-page-label='t6'>
			<div class='pf-hotspot' style='top:80px;left:88px;width:242px;height:136px;' onclick='u("https://montecristo.com.br/produto/X82310D91B1S1-ENDURANCE-PRO")'></div>
			<div class='pf-hotspot' style='top:259px;left:82px;width:245px;height:47px;' onclick='u("https://montecristo.com.br/produto/PU-21-IGRE-Pulseira-Rings-Vermelha")'></div>
			<div class='pf-hotspot' style='top:373px;left:83px;width:250px;height:53px;' onclick='u("https://montecristo.com.br/produto/PU-20-IGRE-Pulseira-Rings-All-Black")'></div>
			<div class='pf-hotspot' style='top:490px;left:82px;width:248px;height:53px;' onclick='u("https://montecristo.com.br/produto/PU-10-IGRE-Pulseira-Rope-All-Black")'></div>
			<div class='pf-hotspot' style='top:583px;left:88px;width:245px;height:128px;' onclick='u("https://montecristo.com.br/relogios/Tag-Heuer/Aquaracer")'></div>
		</div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page7.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page7_th.webp' data-page-label='t7'></div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page8.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page8_th.webp' data-page-label='t8'>
			<div class='pf-hotspot' style='top:90px;left:74px;width:260px;height:145px;' onclick='u("https://montecristo.com.br/produto/606700-Carteira-Victorinox-Victoria-Small")'></div>
			<div class='pf-hotspot' style='top:241px;left:74px;width:289px;height:145px;' onclick='u("https://montecristo.com.br/produto/08501217-Canivete-Outrider-Damasco")'></div>
			<div class='pf-hotspot' style='top:402px;left:77px;width:260px;height:148px;' onclick='u("https://montecristo.com.br/produto/1360163-Canivete-Spartan-Madeira-Nogueira")'></div>
			<div class='pf-hotspot' style='top:565px;left:64px;width:269px;height:145px;' onclick='u("https://montecristo.com.br/produto/0970163-Canivete-Wine-Master")'></div>
		</div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page9.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page9_th.webp' data-page-label='t9'></div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page10.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page10_th.webp' data-page-label='t10'>
			<div class='pf-hotspot' style='top:98px;left:97px;width:230px;height:122px;' onclick='u("https://montecristo.com.br/produto/PU30879-Pulseira-Masculina-Shot")'></div>
			<div class='pf-hotspot' style='top:275px;left:71px;width:256px;height:92px;' onclick='u("https://montecristo.com.br/produto/PU30372-Pulseira-Force")'></div>
			<div class='pf-hotspot' style='top:457px;left:71px;width:271px;height:67px;' onclick='u("https://montecristo.com.br/produto/PU31145-Bracelete-ROSSO-X-Steel")'></div>
			<div class='pf-hotspot' style='top:597px;left:101px;width:226px;height:113px;' onclick='u("https://montecristo.com.br/produto/PI27716-Pingente-Sao-Bento")'></div>
		</div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page11.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page11_th.webp' data-page-label='t11'></div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page12.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page12_th.webp' data-page-label='t12'>
			<div class='pf-hotspot' style='top:113px;left:77px;width:250px;height:159px;' onclick='u("https://montecristo.com.br/produto/GA31120-Gargantilha-Rosso-Cruz")'></div>
			<div class='pf-hotspot' style='top:332px;left:72px;width:255px;height:136px;' onclick='u("https://montecristo.com.br/produto/AN30864-Anel-Masculino-Sterling")'></div>
			<div class='pf-hotspot' style='top:546px;left:77px;width:240px;height:153px;' onclick='u("https://montecristo.com.br/produto/AN30861-Anel-Masculino-Round-Cube")'></div>
		</div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page13.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page13_th.webp' data-page-label='t13'></div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page14.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page14_th.webp' data-page-label='t14'>
			<div class='pf-hotspot' style='top:98px;left:86px;width:244px;height:136px;' onclick='u("https://montecristo.com.br/relogios/Tag-Heuer/Aquaracer")'></div>
			<div class='pf-hotspot' style='top:283px;left:75px;width:255px;height:120px;' onclick='u("https://montecristo.com.br/produto/CO31328-Escapulario-Luminous")'></div>
			<div class='pf-hotspot' style='top:455px;left:69px;width:271px;height:76px;' onclick='u("https://montecristo.com.br/produto/PU-03-JKRE-Bracelete-Double-Knot-Prata-e-Couro-Marrom")'></div>
			<div class='pf-hotspot' style='top:564px;left:75px;width:271px;height:143px;' onclick='u("https://montecristo.com.br/produto/PU30877-Pulseira-Masculina-Atom")'></div>
		</div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page15.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page15_th.webp' data-page-label='t15'></div>
		<div class='page' data-background-file='<?php echo $pasta ?>pageflipdata/page16.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page16_th.webp' data-page-label='t16'>
			<div class='pf-hotspot' style='top:98px;left:65px;width:283px;height:120px;' onclick='u("https://montecristo.com.br/produto/CO29335-Escapulario-Judaico-Chai-e-Estrela-de-Davi")'></div>
			<div class='pf-hotspot' style='top:253px;left:83px;width:240px;height:142px;' onclick='u("https://montecristo.com.br/produto/CO268-Escapulario-Classico")'></div>
			<div class='pf-hotspot' style='top:416px;left:63px;width:260px;height:133px;' onclick='u("https://montecristo.com.br/produto/CO31188-Escapulario-Jesuss-Heart")'></div>
			<div class='pf-hotspot' style='top:608px;left:77px;width:255px;height:116px;' onclick='u("https://montecristo.com.br/produto/GA-6681-Escapulario-N-S-do-Carmo-e-S-C-Jesus")'></div>
		</div>
		<div class='cover' data-background-file='<?php echo $pasta ?>pageflipdata/page17.webp' data-thumbnail-image='<?php echo $pasta ?>pageflipdata/page17_th.webp' data-page-label='t17'>
			<div class='pf-hotspot' style='top:209px;left:134px;width:181px;height:20px;' onclick='u("https://www.instagram.com/montecristo.joalheria/")'></div>
			<div class='pf-hotspot' style='top:259px;left:132px;width:181px;height:18px;' onclick='u("https://br.pinterest.com/mjoalheria/")'></div>
			<div class='pf-hotspot' style='top:305px;left:132px;width:181px;height:25px;' onclick='u("https://www.facebook.com/montecristojoalheria/")'></div>
			<div class='pf-hotspot' style='top:382px;left:121px;width:215px;height:25px;' onclick='u("https://montecristo.com.br/")'></div>
			<div class='pf-hotspot' style='top:431px;left:90px;width:269px;height:31px;' onclick='u("https://api.whatsapp.com/send/?phone=5511964175881&text&app_absent=0")'></div>
			<div class='pf-hotspot' style='top:482px;left:103px;width:45px;height:30px;' onclick='u("https://montecristo.com.br/rolex")'></div>
			<div class='pf-hotspot' style='top:486px;left:187px;width:58px;height:25px;' onclick='u("https://montecristo.com.br/relogios/Cartier")'></div>
			<div class='pf-hotspot' style='top:486px;left:281px;width:65px;height:27px;' onclick='u("https://montecristo.com.br/relogios/Breitling")'></div>
			<div class='pf-hotspot' style='top:536px;left:265px;width:60px;height:32px;' onclick='u("https://montecristo.com.br/relogios/Victorinox")'></div>
			<div class='pf-hotspot' style='top:540px;left:139px;width:91px;height:30px;' onclick='u("https://montecristo.com.br/relogios/Tag-Heuer")'></div>
		</div>
