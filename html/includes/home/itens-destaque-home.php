        ...
        <div class="row sequencia1">
            <div class="col-md-6">
                <picture>
                    ...
                    <!-- JPG DESKTOP -->
                    <source srcset="<?php echo base_url(image_compatibility($imagem, 'jpg')); ?>" type="image/jpg">

                    <img src="" class="img-responsive" title="<?php echo "Imagem ilustrativa da categoria $titulo" ?>"
                        alt="<?php echo $conteudo ?>" width="555" height="381" loading="lazy" />
                </picture>
            </div>
            <div class="col-md-6">
