...
<section class="container detalhe-produto" style="position:relative">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            foreach ($imagens as $img) : ?>
                                <div class="swiper-slide">
                                    <img style="width:100%;" data-id='<?php echo base_url($img); ?>' class="img-responsive modal_zoom" src="<?php echo base_url($img); ?>">
                                </div>
                                <?php $i++; ?>
                            <?php endforeach; ?>
                        </div>
        ...
        ?>
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xs-8">
                    <a href="<?php echo base_url('admin/upload/item/' . $item->imagem); ?>" style="cursor:crosshair;" class="imgdetzoom" rel="imgdetzoom">
                        <img class="cloudzoom img-zoom-1 img-responsive" id="zoom1" src="<?php echo base_url('admin/upload/item/' . $item->imagem); ?>" data-cloudzoom="
								zoomImage:'<?php echo base_url('admin/upload/item/' . @$item->imagem); ?>',
								zoomSizeMode:'image',
								tintColor:'#fff',
                ...
                <div class="col-md-3 col-sm-3 col-xs-3" style="z-index: 1">
                    ...
                    for ($i = 1; $i < 3; $i++) {
                        if (isset($imagens[$i])) {
                            if ($i == 2) {
                    ?>
                                <img src="<?php echo base_url($imagens[$i]); ?>" onclick="switch_img('<?php echo base_url($imagens[$i]); ?>',2);" id="img_det_2" data-img="<? echo base_url($imagens[$i]); ?>" class="img-responsive img_det_2 cloudzoom-gallery" data-cloudzoom="
										useZoom : '#zoom1',imagem: '<? echo base_url($imagens[$i]); ?>'
										">
                            <?php
                            } else {
                            ?>
                                <img src="<?php echo base_url($imagens[$i]); ?>" onclick="switch_img('<?php echo base_url($imagens[$i]); ?>',1);" id="img_det_1" style="z-index: 1" data-img="<?php echo base_url($imagens[$i]); ?> " class="img-responsive img_det_1 cloudzoom-gallery" data-cloudzoom="
								useZoom:'#zoom1',imagem : '<? echo base_url($imagens[$i]); ?>'">
                                <br>
                    <?php
                            }
    ...
    <div class="row">
        <div class="col-md-4 col-sm-4 row hide">
            ...
            if ($item->imagem_d1 != '') {
                ...
                if ($img != '') {
            ?>
                    <img class="cloudzoom img-zoom-2" id="zoom2" src="<?php echo timthumb_url($img, '612', '469') ?>" style="display: none" data-cloudzoom="
                    ...
                    <a href="<?php echo base_url($img) ?>" style="cursor:crosshair; display: none" class="imgdetzoom" rel="imgdetzoom"><?php echo base_url($img) ?></a>
                <?php
                }
                $qtd_imagens++;
            }
            ...
            if ($item->imagem_d3 != '') {
                ...
                if ($img != '') {
                ?>
                    <img class="cloudzoom img-zoom-3" id="zoom3" src="<?php echo timthumb_url($img, '612', '469') ?>" style="display: none" data-cloudzoom="
						 zoomImage: '<?php echo base_url($img) ?>',
						 zoomSizeMode: 'image',
						 tintColor:'#fff',
						 tintOpacity:0,
            ...
            if ($qtd_imagens > 1) : ?>
                <a href="#" class="img-det-nav img-det-prev js-hide"><img src="<?php echo base_url('img/bgi/prev-btn.png') ?>" /></a>
                <a href="#" class="img-det-nav img-det-next js-hide"><img src="<?php echo base_url('img/bgi/next-btn.png') ?>" /></a>
            <?php endif; ?>
        ...
        <div class="col-md-4 row hide">
            ...
            <a href="<?php echo base_url('admin/upload/item/' . $item->imagem) ?>" style="cursor:crosshair;" class="imgdetzoom" rel="imgdetzoom" />
            <img class="cloudzoom img-zoom-1 img-responsive" id="zoom1" src="<?php echo timthumb_url('admin/upload/item/' . $item->imagem, '612', '469') ?>" data-cloudzoom="
                     zoomImage: '<?php echo base_url('admin/upload/item/' . @$item->imagem) ?>',
                     zoomSizeMode: 'image',
                     tintColor:'#fff',
                     tintOpacity:0,
        ...
        <div class="col-md-4 descricao-detalhe hidden-md hidden-lg">
            ...
            <div class="icones-contato">
                ...
                <ul style="display:table;margin:0 auto;">
                    <li><a href="http://instagram.com/montecristo.joalheria"><span class="screen-reader-text">Instagram</span> <i class="fa fa-instagram"></i></a></li>
                    <li><a href="#" class="js-fb-share"><span class="screen-reader-text js-fb-share">Facebook</span> <i class="fa fa-facebook"></i></a></li>
                    <li><a data-pin-height="28" class="pinterest" href="#"><span class="screen-reader-text pinterest">Pinterest</span> <i class="fa fa-pinterest-p" aria-hidden="true"></i></a></li>
                    ...
                    <li><a href="<?php echo site_url('contato') ?>"><span class="screen-reader-text">Contato</span><i class="fa fa-phone" aria-hidden="true"></i></a></li>
                    <li><a href="https://wa.me/5511964175881?text=Oi,%20tenho%20interesse%20no%20produto%20<?php echo site_url("produto/" . $item->slug); ?>"><span class="screen-reader-text">Whatsapp</span><i class="fa fa-whatsapp" aria-hidden="true"></i></a></li>
                                ...
                                <?php if ($item->st_habilita_aro == 'S') : ?>
                                    ...
                                    <?php if ($item->tipo_alianca == 'dupla') : ?>
                                        ...
                                        <tr>
                                            <td style="text-align: left" class="alianca-1">
                                                ...
                                                <?php echo form_dropdown('aro1', array('' => 'Aro da aliança') + array_combine($aros_disponiveis, $aros_disponiveis), set_value('noivo')); ?>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="text-align: left" class="alianca-1">
                                                ...
                                                <?php echo form_dropdown('aro2', array('' => 'Aro da aliança') + array_combine($aros_disponiveis, $aros_disponiveis), set_value('noiva')); ?>
                                            </td>
                                            <td style="text-align: left" class="alianca-2">Qtd<br>
                                            ...
                                            <td colspan="3" class="select-inline">
                                                <p style="font-size: 11px;line-height: 11px; margin-top:5px; margin-bottom: 0px; padding-bottom: 0px;">
                                                    ...
                                                    <?php if ($aro_personalizado) : ?>
                                                        <br><br>Caso o aro desejado não esteja na lista,<br><a class="fancybox" rel="group" href="#register-page" style="font-size: 11px;">clique aqui</a> e registre seu
                                                        interesse.
                                                    <?php endif; ?>
                                                </p>
                                            </td>
                                    ...
                                    <?php elseif ($item->tipo_alianca == 'simples') : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <?php echo form_dropdown('aro', array_combine($aros_disponiveis, $aros_disponiveis), set_value('noivo')); ?>
                                            </td>
            ...
            <?php if (!($item->qtd_estoque > 0 && $item->preco > 0)) : ?>
                <h4 class="register-link"><a href="#register-page" class="fancybox" rel="group">REGISTRE SEU INTERESSE</h4>
                </a>
            <?php endif; ?>
    ...
    ?>
        ...
        ?>
            <h2 class="text-center sub-header">Veja mais <?php echo $caracteristica->carac_nome ?> <?php echo $caracteristica->nome ?></h2>
            <hr>
            <div class="row">
                <?php
                foreach ($produtos as $row) {
...
<noscript>
    <div style="display:inline;">
        <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/867541032/?label=dzvZCJLcmHEQqMDWnQM&amp;guid=ON&amp;script=0" />
    </div>
</noscript>
</section>
